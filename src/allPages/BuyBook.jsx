...
const BuyBook = ({ sellingbook }) => {
    const { availability, price, author, title, image, rating, details, id } = sellingbook;

    return (
        <div className="card bg-base-100 shadow-lg rounded-xl w-80">
            ...
            <div className="card-body">
                ...
                <p className="text-md font-semibold mt-1">Price: {price} $</p>

                <div className="flex mt-4 gap-2">

                    <button
                        className={`
                        basis-2/3 px-4 py-2 rounded-lg border-2 font-bold 
                    ...
                    <button
                        className={`
                        flex-1 px-4 py-2 rounded-lg border-2 font-bold 
                        bg-[#f7f5f4] border-[#664932] text-[#664932]
                        transition-all duration-300
                        hover:bg-[#664932] hover:text-[#f7f5f4]
                        `}
  ...
  <div className="modal-box max-w-5xl py-24">
    ...
    <div className="flex flex-col md:flex-row gap-6 items-center">
      ...
      <div className="md:w-2/3 text-center md:text-left">
        ...
        <p className="text-2xl text-gray-600 mb-2">Author: {author}</p>
        ...
        <div className="modal-action justify-center md:justify-start mt-4">
          <form method="dialog">
            <button
              className="
                px-6 py-2 rounded-lg border-2 font-bold 
                bg-[#f7f5f4] border-[#664932] text-[#664932]
                transition-all duration-300
                hover:bg-[#664932] hover:text-[#f7f5f4]
              "
